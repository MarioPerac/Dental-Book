...
namespace DentalBook.Themes
{
    internal class DarkTheme : IBaseTheme
    {
        ...
        public Color MaterialDesignBackground { get; } = (Color)ColorConverter.ConvertFromString("#212121");


        public Color MaterialDesignPaper { get; } = (Color)ColorConverter.ConvertFromString("#FF303030");


        public Color MaterialDesignCardBackground { get; } = (Color)ColorConverter.ConvertFromString("#FF303030");
        ...
        public Color MaterialDesignBodyLight { get; } = (Color)ColorConverter.ConvertFromString("#666565");
